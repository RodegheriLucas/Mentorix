...
function IOSStatusBar() {
  ...
  return (
    <div style={{
      ...
      padding: '21px 24px 0', boxSizing: 'border-box',
      position: 'relative', zIndex: 20, width: '100%', height: 62,
    }}>
      <span style={{
...
export const PhoneFrame: React.FC<PhoneFrameProps> = ({ children, bottomBar }) => {
  return (
    <div style={{
      ...
      {/* Main layout: status space + content + optional tab bar + home indicator space */}
      <div style={{
        height: '100%',
        display: 'flex',

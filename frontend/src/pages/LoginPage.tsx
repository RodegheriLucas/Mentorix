...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1,
        background: 'linear-gradient(145deg, #1A0E5C 0%, #3A2885 45%, #5D46B8 80%, #7A5FD0 100%)',
        display: 'flex',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            {FEATURES.map((f, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                ...
                <div>
                  <div style={{
                    fontFamily: 'var(--f-head)', fontWeight: 600, fontSize: 14,
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <h2 style={{
            fontFamily: 'var(--f-head)', fontWeight: 700, fontSize: 28,
